...
@Autonomous(name = "Red Alliance Auto 3")
public class RedAllianceAuto3 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // Switch Limelight to Pipeline 0 (Configured for Red Alliance Tag IDs)
        ...
        if (opModeIsActive()) {
            // STEP 1: Drive from Start (56, 8) to Shooting Spot (56, 36)
            ...
            // STEP 4: Drive from Shooting Spot (56, 36) to Red Loading Zone (8, 115)
    ...
    private void driveTimed(double driveY, double strafeX, double turnR, long durationMs) {
        ...
        while (opModeIsActive() && (System.currentTimeMillis() - startTime < durationMs)) {
            ...
            trackTurretTarget("Red"); // Continuously track tags during movement
        }
    ...
    private void trackTurretTarget(String allianceName) {
        ...
        if (result != null && result.isValid()) {
            ...
            if (fiducials != null && !fiducials.isEmpty()) {
                ...
                telemetry.addLine("No active cluster elements tracked inside Pipeline 0.");
            }
        } else {
