...
@Autonomous(name = "Blue Alliance Auto 2")
public class BlueAllianceAuto2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // Pipeline 1 for Blue Alliance AprilTags
        limelight.pipelineSwitch(1);
        limelight.start();

        telemetry.addData("Status", "Blue Alliance Auto 2 Ready.");
        telemetry.update();

        waitForStart();

        if (opModeIsActive()) {
            // STEP 1: Drive from Start (88, 8) to Shooting Position (88, 36) -> Drive forward 28 inches
            ...
            // STEP 4: Move from Shooting Spot (88, 36) to Loading Zone (136, 115)
            // Strafe right toward X = 136, then drive forward toward Y = 115
            driveTimed(0.0, 0.5, 0.0, 2200);  // Strafe right
            driveTimed(0.5, 0.0, 0.0, 3500);  // Drive forward to Blue Loading Zone
        }
